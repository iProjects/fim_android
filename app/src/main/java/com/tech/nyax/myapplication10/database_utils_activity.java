...
public class database_utils_activity extends AppCompatActivity {

    private final static String TAG = database_utils_activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.database_utils_layout);
...
//        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.argb(128, 0, 0, 0)));
        ...
        btnsyncdatabase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
					...
					utilz.getInstance(getApplicationContext()).globalloghandler("launching sync_datastore_activity...", TAG, 1, 1);
			
                    final Intent sync_datastore_activity = new Intent(getApplicationContext(), sync_datastore_activity.class);
                    startActivity(sync_datastore_activity);
    ...
    private class createDataBaseBackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            simpleWaitDialog = ProgressDialog.show(database_utils_activity.this, "creating database...", "excecuting task...");
        ...
        protected void onPostExecute(String result) {
            ...
            utilz.getInstance(getApplicationContext()).globalloghandler(_info, TAG, 1, 1, "database_utils_activity.onPostExecute", "database_utils_activity.onPostExecute");
    ...
    private class exportDatabaseBackgroundTask extends AsyncTask<Void, Void, responsedto> {
        ...
        protected void onPreExecute() {
            ...
            simpleWaitDialog = ProgressDialog.show(database_utils_activity.this, "exporting database...", "excecuting task...");
    ...
    private class importDatabaseBackgroundTask extends AsyncTask<Uri, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            simpleWaitDialog = ProgressDialog.show(database_utils_activity.this, "importing database...", "excecuting task...");
    ...
    private class syncDatabaseBackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            simpleWaitDialog = ProgressDialog.show(database_utils_activity.this, "synchronizing database...", "excecuting task...");
        ...
        protected void onPostExecute(String result) {
            ...
            utilz.getInstance(getApplicationContext()).globalloghandler(result, TAG, 1, 1, "database_utils_activity.onPostExecute", "database_utils_activity.onPostExecute");
    ...
    String synchronizecropstodevice(List<cropdto> _lst_dtos) {
        ...
        try {
            ...
            db = new DatabasehelperUtilz(database_utils_activity.this);
            db.openDataBase();
