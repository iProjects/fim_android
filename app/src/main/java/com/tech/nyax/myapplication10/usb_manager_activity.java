...
public class usb_manager_activity extends AppCompatActivity {

    private final static String TAG = usb_manager_activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usb_manager_layout);
