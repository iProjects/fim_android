...
public class FragmentOne extends Fragment {
    ...
    public static FragmentOne newInstance(final String searchterm) {
        final FragmentOne myFragment = new FragmentOne();
...
//Do your stuff to place
                    ...
                    if (_isnetworkavailable) {
                        utilz.getInstance(getActivity().getApplicationContext()).globalloghandler("network available", FragmentOne.class.getSimpleName(), 1, 0, "network available", "network available");
                    }
                } catch (Exception ex) {
// TODO: Handle the error.
                }
...
//WiFi Connection success, return true
            utilz.getInstance(getActivity().getApplicationContext()).globalloghandler("connected to wifi", FragmentOne.class.getSimpleName(), 1, 0, "connected to wifi", "connected to wifi");
            return true;

        } catch (Exception ex) {
            utilz.getInstance(getActivity().getApplicationContext()).globalloghandler(ex.toString(), FragmentOne.class.getSimpleName(), 1, 0, "FragmentOne.ConnectToNetworkWEP", "FragmentOne.ConnectToNetworkWEP");
