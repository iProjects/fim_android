...
public class editmanufactureractivity extends AppCompatActivity {
    ...
    private final static String TAG = editmanufactureractivity.class.getSimpleName();
    Button btnupdatemanufacturer;
	ImageButton imgbtnupdatemanufacturer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_manufacturer_layout);
        ...
        imgbtnupdatemanufacturer = findViewById(R.id.imgbtnupdatemanufacturer);
        imgbtnupdatemanufacturer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    ...
                    new saverecordBackgroundAsyncTask().execute(_manufacturerdto);
...
//            _progressapisingleton.showProgress(getApplicationContext(), getApplicationContext().getResources().getString(R.string.editmanufacturerprogress), true);
            ...
            simpleWaitDialog = ProgressDialog.show(editmanufactureractivity.this,
...
//            Log.d(TAG, "doInBackground");
            ...
            db = new DatabasehelperUtilz(editmanufactureractivity.this);
            db.openDataBase();
            //db.createtables();
    ...
    private class saverecordBackgroundAsyncTask extends AsyncTask<manufacturerdto, Void, String> {
...
//            Log.d(TAG, "doInBackground");
            ...
            db = new DatabasehelperUtilz(editmanufactureractivity.this);
            db.openDataBase(); 
            db.updatemanufacturer(_manufacturerdto[0]);
            db.close();
        ...
        protected void onPostExecute(String s) {
            ...
            utilz.getInstance(getApplicationContext()).globalloghandler("record successfully persisted in datastore...", TAG, 1, 1, "editmanufactureractivity.onPostExecute", "editmanufactureractivity.onPostExecute");
